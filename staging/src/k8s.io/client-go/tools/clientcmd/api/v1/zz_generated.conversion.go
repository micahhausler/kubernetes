...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*HTTPSignatureConfig)(nil), (*api.HTTPSignatureConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_HTTPSignatureConfig_To_api_HTTPSignatureConfig(a.(*HTTPSignatureConfig), b.(*api.HTTPSignatureConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.HTTPSignatureConfig)(nil), (*HTTPSignatureConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_HTTPSignatureConfig_To_v1_HTTPSignatureConfig(a.(*api.HTTPSignatureConfig), b.(*HTTPSignatureConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*HTTPSignatureHeader)(nil), (*api.HTTPSignatureHeader)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_HTTPSignatureHeader_To_api_HTTPSignatureHeader(a.(*HTTPSignatureHeader), b.(*api.HTTPSignatureHeader), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.HTTPSignatureHeader)(nil), (*HTTPSignatureHeader)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_HTTPSignatureHeader_To_v1_HTTPSignatureHeader(a.(*api.HTTPSignatureHeader), b.(*HTTPSignatureHeader), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*HTTPSignatureKeyDerivation)(nil), (*api.HTTPSignatureKeyDerivation)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_HTTPSignatureKeyDerivation_To_api_HTTPSignatureKeyDerivation(a.(*HTTPSignatureKeyDerivation), b.(*api.HTTPSignatureKeyDerivation), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.HTTPSignatureKeyDerivation)(nil), (*HTTPSignatureKeyDerivation)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_HTTPSignatureKeyDerivation_To_v1_HTTPSignatureKeyDerivation(a.(*api.HTTPSignatureKeyDerivation), b.(*HTTPSignatureKeyDerivation), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*HTTPSignatureKeyDerivationStep)(nil), (*api.HTTPSignatureKeyDerivationStep)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_HTTPSignatureKeyDerivationStep_To_api_HTTPSignatureKeyDerivationStep(a.(*HTTPSignatureKeyDerivationStep), b.(*api.HTTPSignatureKeyDerivationStep), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.HTTPSignatureKeyDerivationStep)(nil), (*HTTPSignatureKeyDerivationStep)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_HTTPSignatureKeyDerivationStep_To_v1_HTTPSignatureKeyDerivationStep(a.(*api.HTTPSignatureKeyDerivationStep), b.(*HTTPSignatureKeyDerivationStep), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_AuthInfo_To_api_AuthInfo(in *AuthInfo, out *api.AuthInfo, s conversion.Scope) error {
	...
	out.HTTPSignature = (*api.HTTPSignatureConfig)(unsafe.Pointer(in.HTTPSignature))
...
func autoConvert_v1_HTTPSignatureConfig_To_api_HTTPSignatureConfig(in *HTTPSignatureConfig, out *api.HTTPSignatureConfig, s conversion.Scope) error {
	*out = *(*api.HTTPSignatureConfig)(unsafe.Pointer(in))
	return nil
}

// Convert_v1_HTTPSignatureConfig_To_api_HTTPSignatureConfig is an autogenerated conversion function.
func Convert_v1_HTTPSignatureConfig_To_api_HTTPSignatureConfig(in *HTTPSignatureConfig, out *api.HTTPSignatureConfig, s conversion.Scope) error {
	return autoConvert_v1_HTTPSignatureConfig_To_api_HTTPSignatureConfig(in, out, s)
}

func autoConvert_api_HTTPSignatureConfig_To_v1_HTTPSignatureConfig(in *api.HTTPSignatureConfig, out *HTTPSignatureConfig, s conversion.Scope) error {
	*out = *(*HTTPSignatureConfig)(unsafe.Pointer(in))
	return nil
}

// Convert_api_HTTPSignatureConfig_To_v1_HTTPSignatureConfig is an autogenerated conversion function.
func Convert_api_HTTPSignatureConfig_To_v1_HTTPSignatureConfig(in *api.HTTPSignatureConfig, out *HTTPSignatureConfig, s conversion.Scope) error {
	return autoConvert_api_HTTPSignatureConfig_To_v1_HTTPSignatureConfig(in, out, s)
}

func autoConvert_v1_HTTPSignatureHeader_To_api_HTTPSignatureHeader(in *HTTPSignatureHeader, out *api.HTTPSignatureHeader, s conversion.Scope) error {
	*out = *(*api.HTTPSignatureHeader)(unsafe.Pointer(in))
	return nil
}

// Convert_v1_HTTPSignatureHeader_To_api_HTTPSignatureHeader is an autogenerated conversion function.
func Convert_v1_HTTPSignatureHeader_To_api_HTTPSignatureHeader(in *HTTPSignatureHeader, out *api.HTTPSignatureHeader, s conversion.Scope) error {
	return autoConvert_v1_HTTPSignatureHeader_To_api_HTTPSignatureHeader(in, out, s)
}

func autoConvert_api_HTTPSignatureHeader_To_v1_HTTPSignatureHeader(in *api.HTTPSignatureHeader, out *HTTPSignatureHeader, s conversion.Scope) error {
	*out = *(*HTTPSignatureHeader)(unsafe.Pointer(in))
	return nil
}

// Convert_api_HTTPSignatureHeader_To_v1_HTTPSignatureHeader is an autogenerated conversion function.
func Convert_api_HTTPSignatureHeader_To_v1_HTTPSignatureHeader(in *api.HTTPSignatureHeader, out *HTTPSignatureHeader, s conversion.Scope) error {
	return autoConvert_api_HTTPSignatureHeader_To_v1_HTTPSignatureHeader(in, out, s)
}

func autoConvert_v1_HTTPSignatureKeyDerivation_To_api_HTTPSignatureKeyDerivation(in *HTTPSignatureKeyDerivation, out *api.HTTPSignatureKeyDerivation, s conversion.Scope) error {
	*out = *(*api.HTTPSignatureKeyDerivation)(unsafe.Pointer(in))
	return nil
}

// Convert_v1_HTTPSignatureKeyDerivation_To_api_HTTPSignatureKeyDerivation is an autogenerated conversion function.
func Convert_v1_HTTPSignatureKeyDerivation_To_api_HTTPSignatureKeyDerivation(in *HTTPSignatureKeyDerivation, out *api.HTTPSignatureKeyDerivation, s conversion.Scope) error {
	return autoConvert_v1_HTTPSignatureKeyDerivation_To_api_HTTPSignatureKeyDerivation(in, out, s)
}

func autoConvert_api_HTTPSignatureKeyDerivation_To_v1_HTTPSignatureKeyDerivation(in *api.HTTPSignatureKeyDerivation, out *HTTPSignatureKeyDerivation, s conversion.Scope) error {
	*out = *(*HTTPSignatureKeyDerivation)(unsafe.Pointer(in))
	return nil
}

// Convert_api_HTTPSignatureKeyDerivation_To_v1_HTTPSignatureKeyDerivation is an autogenerated conversion function.
func Convert_api_HTTPSignatureKeyDerivation_To_v1_HTTPSignatureKeyDerivation(in *api.HTTPSignatureKeyDerivation, out *HTTPSignatureKeyDerivation, s conversion.Scope) error {
	return autoConvert_api_HTTPSignatureKeyDerivation_To_v1_HTTPSignatureKeyDerivation(in, out, s)
}

func autoConvert_v1_HTTPSignatureKeyDerivationStep_To_api_HTTPSignatureKeyDerivationStep(in *HTTPSignatureKeyDerivationStep, out *api.HTTPSignatureKeyDerivationStep, s conversion.Scope) error {
	*out = *(*api.HTTPSignatureKeyDerivationStep)(unsafe.Pointer(in))
	return nil
}

// Convert_v1_HTTPSignatureKeyDerivationStep_To_api_HTTPSignatureKeyDerivationStep is an autogenerated conversion function.
func Convert_v1_HTTPSignatureKeyDerivationStep_To_api_HTTPSignatureKeyDerivationStep(in *HTTPSignatureKeyDerivationStep, out *api.HTTPSignatureKeyDerivationStep, s conversion.Scope) error {
	return autoConvert_v1_HTTPSignatureKeyDerivationStep_To_api_HTTPSignatureKeyDerivationStep(in, out, s)
}

func autoConvert_api_HTTPSignatureKeyDerivationStep_To_v1_HTTPSignatureKeyDerivationStep(in *api.HTTPSignatureKeyDerivationStep, out *HTTPSignatureKeyDerivationStep, s conversion.Scope) error {
	*out = *(*HTTPSignatureKeyDerivationStep)(unsafe.Pointer(in))
	return nil
}

// Convert_api_HTTPSignatureKeyDerivationStep_To_v1_HTTPSignatureKeyDerivationStep is an autogenerated conversion function.
func Convert_api_HTTPSignatureKeyDerivationStep_To_v1_HTTPSignatureKeyDerivationStep(in *api.HTTPSignatureKeyDerivationStep, out *HTTPSignatureKeyDerivationStep, s conversion.Scope) error {
	return autoConvert_api_HTTPSignatureKeyDerivationStep_To_v1_HTTPSignatureKeyDerivationStep(in, out, s)
}
