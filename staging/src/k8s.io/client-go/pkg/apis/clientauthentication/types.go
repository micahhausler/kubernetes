...
type ExecCredentialSpec struct {
	...
	// +optional
	HTTPSignature *HTTPSignatureRequest
}
...
type ExecCredentialStatus struct {
	...
	// +optional
	HTTPSignature *HTTPSignatureCredential
}
...
type HTTPSignatureRequest struct {
	...
	// +optional
	SignedHeaders []HTTPSignatureHeader
}
...
type HTTPSignatureCredential struct {
	...
	// +optional
	Secret string `datapolicy:"secret-key"`
	...
	// way.
	// +optional
	SecretBase64 string `datapolicy:"secret-key"`

	// PrivateKey is a PEM-encoded private key, for the asymmetric algorithms.
	// +optional
	PrivateKey string `datapolicy:"security-key"`
	...
	// +optional
	SignedHeaders map[string]string `datapolicy:"token"`
}
